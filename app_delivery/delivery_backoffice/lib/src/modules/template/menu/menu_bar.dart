...
//faz com que a pagina auto-identifique o menu que está, quando voltar para pagina anterior
  @override
...
//faz com que a pagina auto-identifique o menu que está, quando acessado através do link
  @override
  void initState() {
    selectedMenu = Menu.findByPath(Modular.to.path);
    super.initState();
