...
import 'package:lab_clinicas_adm/src/repositories/patient_information_form/patiant_information_form_repository.dart';
...
class CheckinController with MessageStateMixin {
  ...
  Future<void> endCheckin() async {
    if (informationForm() != null) {
      final result = await _patiantInformationFormRepository.updateStatus(
